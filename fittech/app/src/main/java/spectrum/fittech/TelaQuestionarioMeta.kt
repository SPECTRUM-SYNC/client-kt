...
@Composable
fun QuestionarioMeta(name: String, modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        Row(
            ...
            Button(
                onClick = {
                    val telaQuestionarioAtividade = Intent(context, TelaQuestionarioAtividade()::class.java)
