...
class TelaInicialDois : ComponentActivity() {
...
@Composable
fun TelaInicialDois(name: String, modifier: Modifier = Modifier) {
    ...
    Column(
            ...
            .pointerInput(Unit) {
                detectHorizontalDragGestures { change, dragAmount ->
                    if (dragAmount < 0) {  // Detecta swipe para a direita
                        ...
                        val intent = Intent(context, TelaInicialTres::class.java)
        ...
        Box(
            ...
            Image(
                painter = painterResource(id = R.mipmap.backgroundinitdois),
...
@Composable
fun TelaInicialDoisPreview() {
    FittechTheme {
        TelaInicialDois("Android")
    }
}