                ...
                Row(
                    modifier = Modifier
                        ...
                        .clickable {
                            ...
                            } else if (idioma == context.getString(R.string.idioma_frances)) {
                            ...
                            } else if (idioma == context.getString(R.string.idioma_alemao)) {
                                setLocale(context as ComponentActivity, "de")
                            }
                        },
